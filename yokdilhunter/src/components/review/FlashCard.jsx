      ...
      <div className={`flip-card-inner ${isFlipped ? 'flipped' : ''}`}>
        ...
        <div className="flip-card-front glass flex flex-col items-center justify-center p-8 cursor-pointer select-none group">
          ...
          <div className="text-center relative z-10">
            ...
            <h2 className="text-5xl sm:text-6xl font-black text-white leading-tight mb-3 break-words hyphens-auto">
              {word.english_word}
            </h2>
            {word.phonetic && (
        ...
        <div className="flip-card-back glass flex flex-col p-6 overflow-auto">
          ...
          <div className="text-center mb-4">
            ...
            <h2 className="text-3xl font-black text-white mb-1 break-words">{word.english_word}</h2>
            {word.phonetic && (
